---
name: auto-commit
description: Create semantic git commits from working tree changes. Use when the user asks to "commit", "auto-commit", "create commits", "save changes to git", or "make semantic commits". Groups changes by purpose and creates conventional commit messages following the Conventional Commits specification.
license: MIT
metadata:
